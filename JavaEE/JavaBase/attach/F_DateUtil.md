...
public class DateUtil {
     ...
     *
     * @param dateString format yyyy-MM-dd HH:mm:ss
     * @param position 从指定位置解析
     * @return 返回 Date
     */
    public static Date getCurrentDate(String dateString,int position) {
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
     ...
     * 获取现在时间 Date
     *
     * @param dateString format yyyy年MM月dd日 HH时mm分ss秒
     * @param position 从指定位置解析
     * @return 返回 Date
     */
    public static Date getCurrentDateCN(String dateString,int position) {
     ...
     */
    public static Date getCurrentDateShort(String dateString,int position) {
