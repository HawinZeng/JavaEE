...
2. 运行java：指将class文件，交给JVM去运行；
	...
	**扩展：Java程序执行过程图解**   
	![](02-Java_program_execute.png)
	![](03-Java_complier.png)
	![](04-Java_JVM_execute.png)
...
详细参考：[阿里巴巴Java开发手册](05-阿里巴巴Java开发手册.pdf)

## 五、常量，变量，数据类型

### 5.1、 常量
1. 在JAVA程序中固定不变的数据，称为常量；
2. 分类：整型常量、浮点型常量、字符常量、字符串常量、布尔常量、空常量（null）### 5.2、 数据类型
