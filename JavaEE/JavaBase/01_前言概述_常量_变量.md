...
扩展： Java是编译语言，同时又是解释型语言；[编译型语言vs脚本语言.md](F_编译型语言vs脚本语言.md)
...
2. 运行java：指将class文件，交给JVM去运行；
  ...
  **扩展：Java程序执行过程图解**   
  ![](F0-Java_program_execute.png)
  ![](F0-Java_complier.png)
  ![](F0-Java_JVM_execute.png)
...
详细参考：[阿里巴巴Java开发手册](F1-阿里巴巴Java开发手册.pdf)
