...
![](attach/img/F0_进程概念.bmp)

- **线程**：线程是进程中的一个执行单元，负责当前进程中程序的执行，一个进程中至少有一个线程。一个进程中是可以有多个线程的，这个应用程序也可以称之为多线程程序。 

  简而言之：一个程序运行后至少有一个进程，一个进程中可以包含多个线程 

![](attach/img/F0_线程概念.bmp)
...
Java程序的入口为main方法，当执行执行该程序，就会创建一个main线程、即为主线程！

![](attach/img/F0_主线程.bmp)
...
![](attach/img/F0_多线程随机性打印结果.bmp)

- **多线程内存图解：**通过start是开辟新栈执行方法，所以多线程互不干涉

![](attach/img/F0_多线程内存图解.bmp)
